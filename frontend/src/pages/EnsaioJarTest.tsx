...
export default function EnsaioJarTest() {
  ...
  const handleSalvarDosagens = async () => {
    ...
    try {
      ...
      setErro(err.response?.data?.detail || 'Erro ao calcular diluições.')
    } finally {
      setSalvando(false)
    }
  }
      ...
      {etapa === 2 && (
        <div className="card space-y-6">
          <div className="border-b border-slate-100 dark:border-slate-800 pb-3">
            ...
            <p className="text-xs text-muted">
              Informe a vazão das bombas dosadoras em mililitros por minuto (ml/min) para a vazão operacional de{' '}
              <b>{vazaoModulo} L/s</b>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              <label className="label">PAC (Coagulante)</label>
              <div className="relative">
                <input
                  ...
                  value={dosPAC}
                  onChange={(e) => setDosPAC(parseFloat(e.target.value) || 0)}
                />
            ...
            <div>
              <label className="label">Hipoclorito (Pré-Cloração)</label>
              <div className="relative">
                <input
                  type="number"
                  step="0.1"
                  ...
                  className="input pr-16"
                  value={dosHipo}
                  onChange={(e) => setDosHipo(parseFloat(e.target.value) || 0)}
                />
                <span className="absolute right-3 top-2 text-xs text-muted">ml/min</span>
              </div>
            </div>
            ...
            <div>
              <label className="label">Alcalinizante (Soda / Cal)</label>
              <div className="relative">
                <input
                  type="number"
                  step="0.1"
                  ...
                  className="input pr-16"
                  value={dosAlc}
                  onChange={(e) => setDosAlc(parseFloat(e.target.value) || 0)}
                />
                <span className="absolute right-3 top-2 text-xs text-muted">ml/min</span>
              </div>
            </div>
            ...
            <div>
              <label className="label">Ácido Fluorsilíssico</label>
              <div className="relative">
                <input
                  type="number"
                  step="0.1"
                  ...
                  className="input pr-16"
                  value={dosFlu}
                  onChange={(e) => setDosFlu(parseFloat(e.target.value) || 0)}
                />
                <span className="absolute right-3 top-2 text-xs text-muted">ml/min</span>
              </div>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse">
                <thead>
                  <tr className="bg-slate-100 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300">
                    ...
                    <th className="p-2.5 font-bold">Coagulante (mL)</th>
                    <th className="p-2.5 font-bold">Alcalinizante (mL)</th>
                    <th className="p-2.5 font-bold">Oxidante (mL)</th>
                    ...
                    >
                      ...
                      <td className="p-2.5">
                        <input
                          ...
                          value={j.dose_pac_ml ?? ''}
                          onChange={(e) =>
                            handleUpdateJarro(idx, 'dose_pac_ml', parseFloat(e.target.value) || 0)
                          }
                        />
                      </td>
                      ...
                      <td className="p-2.5">
                        <input
                          ...
                          value={j.dose_alc_ml ?? ''}
                          onChange={(e) =>
                            handleUpdateJarro(idx, 'dose_alc_ml', parseFloat(e.target.value) || 0)
                          }
                        />
                      </td>
                      ...
                      <td className="p-2.5">
                        <input
                          ...
                          step="0.1"
                          className="input w-16 py-1 px-2 text-xs"
                          value={j.dose_hipo_ml ?? ''}
                          onChange={(e) =>
                            handleUpdateJarro(idx, 'dose_hipo_ml', parseFloat(e.target.value) || 0)
                          }
                        />
                      </td>
