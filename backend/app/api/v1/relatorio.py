...
def gerar_relatorio_tecnico(
    ...
    return {
        ...
        "dosagens_planta": {
            "unidade": dos.unidade if dos else "ml_min",
            ...
            "dosagem_pac_ppm": dos.dosagem_pac_ppm if dos else 0.0,
            "dosagem_hipo_ppm": dos.dosagem_hipo_ppm if dos else 0.0,
            "dosagem_alc_ppm": dos.dosagem_alc_ppm if dos else 0.0,
            "dosagem_flu_ppm": dos.dosagem_flu_ppm if dos else 0.0,
            "pac_conc_perc": dos.pac_conc_perc if dos else None,
            "pac_densidade": dos.pac_densidade if dos else None,
            "hipo_conc_perc": dos.hipo_conc_perc if dos else None,
            "hipo_densidade": dos.hipo_densidade if dos else None,
            "alc_conc_perc": dos.alc_conc_perc if dos else None,
            "alc_densidade": dos.alc_densidade if dos else None,
            "flu_conc_perc": dos.flu_conc_perc if dos else None,
            "flu_densidade": dos.flu_densidade if dos else None,
        ...
        "jarros": [
            {
                ...
                "dose_pac_ppm": j.dose_pac_ppm,
                "dose_hipo_ppm": j.dose_hipo_ppm,
                "dose_alc_ppm": j.dose_alc_ppm,
                "dose_flu_ppm": j.dose_flu_ppm,
        ...
        "jarro_otimo": {
            ...
            "dose_pac_ppm": jarro_otimo.dose_pac_ppm,
